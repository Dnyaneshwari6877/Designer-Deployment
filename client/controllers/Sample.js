...
//   const { title, description, category, images, designerID } = req.query; // Data from the request body

//   console.log(title, description, images, category, designerID);
...
const uploadSample = async (req, res) => {
  ...
  const { title, description, types, designerID, category } = req.body; // Accessing data from the request body
